...
approximately 42,898 participants with T1-weighted structural MRI. After
...
effect (\(\beta\) = 0.034, p \textless{} .001), followed by
HC\textsubscript{RES} (\(\beta\) = 0.028, p = 0.027), with HVR not
significant (\(\beta\) = 0.008, p = 0.545). The memory-specific factor
(Memory\textsubscript{s}) could not be reliably estimated in either sex
and is therefore not reported here (see Table S15 for factor loadings).
